#!/bin/bash
# Generate the clk_wiz_0 MMCM IP (100 MHz -> 12.288 MHz core + 14.318 MHz sound)
# for the Basys3 port and place its Verilog wrappers where
# arcade_pooyan_basys3.xpr expects them.
#
# The project's .xpr references two imported files:
...
# Absolute path to this machine's basys3 port tree.
XPR_DIR="$(cd "$(dirname "$0")/../../.." && pwd)/basys3"
CLK_WIZ_IMPORT_DIR="$XPR_DIR/arcade_pooyan_basys3.srcs/sources_1/imports/clk_wiz_0"
